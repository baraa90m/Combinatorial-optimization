class Graph:
    ...
    def add_edge(self, u, v, weight):
        '''
        This method is for adding an edge, with an edge weight
        value, to the undirected graph
        :param u:
        :param v:
        :param weight:
        :return:
    ...
    def add_vertex_data(self, vertex, data):
        '''
        This method is used for giving names to the vertices,
        like for example 'A' or 'B' etc.
        :param vertex:
        :param data:
        :return:
        '''
